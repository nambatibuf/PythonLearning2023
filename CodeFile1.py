...
def eas503_ex11(input_string):
    ...
    temp2=(f"The input string '{input_string}' has {temp} characters.")
    return temp2
    # END SOLUTION
...
def eas503_ex15(number_of_people, number_of_pizzas):
    ...
    # BEGIN SOLUTION
    total_slices=number_of_pizzas*8
    pizza_pp=int(total_slices/number_of_people)
    leftover=total_slices-pizza_pp*number_of_people;
    leftover=int(leftover)

    return f"There are {number_of_people} people with {number_of_pizzas} pizzas.\nEach person gets {pizza_pp} pieces of pizza.\nThere are {leftover} leftover pieces."
    # END SOLUTION
...
def eas503_ex16(length, width):
    ...
    import math
    # BEGIN SOLUTION
    paint_needed=math.ceil((length*width)/350)
    return f"You will need to purchase {paint_needed} gallons of paint to cover {length*width} square feet."
    # END SOLUTION
...
def eas503_ex19(value):
    ...
    # BEGIN SOLUTION
    return f'{"The value is:":<14}{value:.6f}{"--":<0}.'
    # END SOLUTION
...
def eas503_ex20(value):
    ...
    """
    # BEGIN SOLUTION
    return f'{"The value is:":<14}{"--":<0}{value:.6f}{"--":<0}.'
    # END SOLUTION
...
def eas503_ex21(hours, wage):
    ...
    if hours>40:
        overtime_wage=hours-40
        return 40*wage+(overtime_wage*1.5*wage)
    else:
        return hours*wage
    # END SOLUTION
...
def eas503_ex25(limit, speed):
    ...
    if limit>=speed:
        ...
        if speed<=90:
            amount=50+5*(speed-limit)
            return amount
        else:
            amount=200
            amount=amount+50+5*(speed-limit)
            return amount
    # END SOLUTION
...
def eas503_ex26(input_string):
    ...
    if lowercase_string==final_string:
        return True
    else:
        return False
    # END SOLUTION
